...
#define ADDR_RCC_AHB1ENR_t 		((RCC_AHB1ENR_t*)0x40023830)
#define GPIOx_MODE_REG 			((GPIOx_MODE_REG_t*)0x40020C00)
#define ADDR_OUTPUT_DATA_REG 	((GPIOx_ODR_t*)0x40020C14)

#define CLOCK_ENABLE 			(0x01)
#define MODE_CONFIG_OUTPUT 		(0x01)
